...
echo "==> P0-RC-09"
"$PY" -m unittest discover -s "${ROOT}/tests/p0_rc_09" -v

echo "==> P0-RC-10"
"$PY" -m unittest discover -s "${ROOT}/tests/p0_rc_10" -v
...
echo "==> P1-01"
"$PY" -m unittest discover -s "${ROOT}/tests/p1_01" -v

echo "==> P1-02"
"$PY" -m unittest discover -s "${ROOT}/tests/p1_02" -v

echo "==> P1-03"
"$PY" -m unittest discover -s "${ROOT}/tests/p1_03" -v

echo "==> P1-04"
"$PY" -m unittest discover -s "${ROOT}/tests/p1_04" -v

echo "==> P1-06"
"$PY" -m unittest discover -s "${ROOT}/tests/p1_06" -v

echo "==> P2-01"
"$PY" -m unittest discover -s "${ROOT}/tests/p2_01" -v

echo "==> P2-02"
"$PY" -m unittest discover -s "${ROOT}/tests/p2_02" -v

echo "==> P2-03"
"$PY" -m unittest discover -s "${ROOT}/tests/p2_03" -v
